...
type Querier interface {
	...
	GetTotalBlockedPaths(ctx context.Context) (int64, error)
	GetTotalChannels(ctx context.Context) (int64, error)
	GetTotalVideos(ctx context.Context) (int64, error)
	GetTotalVideosByChannelId(ctx context.Context, channelID pgtype.UUID) (int64, error)
	...
	IncrementBlockedPathErrorCount(ctx context.Context, arg IncrementBlockedPathErrorCountParams) error
